...
117. HERMES_START	
118. HERMES_HOME	
119. HERMES_INSTALL_DIR	
120. OPENCLAW_GATEWAY_TOKEN	
121. OPENCLAW_LITELLM_MODEL	
122. HERMES_LITELLM_MODEL	
123. HERMES_API_SERVER_KEY	
124. TELEGRAMTOKEN_OPENCLAW	
125. OPENCLAW_TELEGRAM_TARGET	
126. GH_TOKEN	
127. TELEGRAMTOKEN_HERMES	
128. BRAVE_API_KEY	
129. CLAUDE_CODE_OAUTH_TOKEN	
49. PV_DACH_DB_HOST	required; autofill blank if PV_DACH_DB_BACKEND=sqlite
#config.conf_example
130. BIP39_PORT	required
131. OPENCLAW_GATEWAY_PORT	required
132. OPENCLAW_CRONTAB	
133. SAFRANO9999_FULLRUN_ON_START	
134. HERMES_DASHBOARD_PORT	required
135. HERMES_API_SERVER_PORT	required
93. KACHELMANN_PORT	required
74. NATURALGROUNDING_VIDEOS_DIR	required; mount-bind absolute path
136. NATURALGROUNDING_SQLITE_PATH	
#container_example
137. BIP39_PUBLISH_PORT	required
138. OPENCLAW_GATEWAY_PUBLISH_PORT	required
139. HERMES_DASHBOARD_PUBLISH_PORT	required
140. HERMES_API_SERVER_PUBLISH_PORT	required
102. KACHELMANN_PUBLISH_PORT	required
141. NATURALGROUNDING_VOLUMES	
142. NATURALGROUNDING_GROUP_ADD	
143. NATURALGROUNDING_STATE_VOLUMES	
144. FEDORA43_AI_VOLUMES	
145. FEDORA43_AI_CODEX_CLI_AUTH_VOLUMES	
146. FEDORA43_AI_OPENCLAW_GPT_AUTH_VOLUMES	
