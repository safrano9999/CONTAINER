...
for name in CERTS HERMES_TAG HERMES_COMMIT HERMES_VERSION ELECTRUM_VERSION \
    ...
    OPENCLAW_VERSION OPENCLAW_NPM_INTEGRITY \
    OPENCLAW_DETERMINISTIC_REPOSITORY OPENCLAW_DETERMINISTIC_TAG \
    OPENCLAW_DETERMINISTIC_ASSET OPENCLAW_DETERMINISTIC_SHA256 \
